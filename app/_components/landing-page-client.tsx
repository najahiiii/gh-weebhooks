    ...
    <div className="relative min-h-screen overflow-hidden bg-slate-950 text-slate-100">
      ...
      <div className="relative z-10 flex min-h-screen flex-col">
        ...
        <main className="flex-1 px-6 pb-24 lg:px-16">
          <section className="mx-auto grid w-full max-w-6xl gap-12 py-16 min-h-[calc(100vh-140px)] lg:grid-cols-[1.2fr,0.8fr] lg:items-center">
            <div className="space-y-6">
              ...
              <p className="max-w-2xl text-base text-slate-300 sm:text-lg">
                Run one service that receives GitHub webhooks, forwards them to
                Telegram, and gives you the tooling to manage bots,
                destinations, subscriptions, and delivery logs without SSHing
                into a box.
              </p>
              {isAuthenticated && signedInLabel && (
                <p className="text-sm text-slate-400">
                  ...
                  . Continue to the dashboard or explore stats below.
                </p>
              )}
              ...
              <CardContent className="space-y-3 text-sm text-slate-300">
                <div className="rounded-xl border border-slate-800/70 bg-slate-950/60 p-4">
                  <p className="text-slate-200">
                    <span className="font-semibold text-sky-200">Push</span> to{" "}
                    <code>main</code>
                  </p>
                  ...
                  <ul className="space-y-1 border-l border-slate-700 pl-3 text-xs">
                    <li>
                      <code className="text-slate-400">ab13e91</code> Fix race
                      condition when parsing payloads
                    </li>
                    <li>
                      <code className="text-slate-400">d8f93aa</code> Align
                      FastAPI markdown renderer with Node port
                    </li>
                    <li>
                      <code className="text-slate-400">fe9012b</code> Add
                      regression coverage for webhook summariser
                    </li>
                  </ul>
                </div>
          ...
          <section
            id="features"
            className="mx-auto w-full max-w-6xl space-y-6 pt-24">
            <div className="flex flex-col gap-2 text-center">
              <h2 className="text-3xl font-semibold text-slate-50">
                What you get
              </h2>
              <p className="text-sm text-slate-400">
                Focused features that cover the full lifecycle of managing
                GitHub → Telegram webhooks.
              </p>
            </div>
