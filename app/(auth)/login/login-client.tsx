      ...
      <div className="relative z-10 grid w-full max-w-5xl grid-cols-1 gap-8 lg:grid-cols-[1.15fr,0.85fr]">
        <Card className="space-y-6 border-slate-800/60 bg-slate-950/80">
          <CardHeader>
            ...
            <CardTitle className="text-3xl sm:text-4xl">
              Manage your bridge with Telegram login
            </CardTitle>
            <CardDescription>
              Authenticate to the dashboard to register bots and destinations,
              create GitHub subscriptions, and monitor delivery logs.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <Alert variant="info">
              <AlertDescription>
                Ensure the domain configured in BotFather matches this frontend.
                Once you are signed in, the session lives in an HTTP-only cookie
            ...
            <ul className="space-y-3 text-sm text-slate-300">
              <li className="flex items-start gap-2">
                ...
                <span>
                  Add multiple bots and sync their Telegram webhooks with a
                  single click.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1 text-sky-300">★</span>
                <span>
                  Register private chats, channels, or topics to receive
              ...
              <li className="flex items-start gap-2">
                <span className="mt-1 text-sky-300">★</span>
                <span>
                  Generate GitHub webhook URLs and secrets instantly for each
                  repository.
                </span>
              </li>
            </ul>
        ...
        <Card className="border-slate-800/60 bg-slate-950/80">
          <CardHeader>
            ...
            <CardDescription>
              Use the button below to sign in with your Telegram account.
            </CardDescription>
          </CardHeader>
              ...
              <Alert variant="warning">
                <AlertDescription className="flex flex-col gap-3 text-xs text-amber-100">
                  <span>
                    ...
                    <code className="rounded bg-slate-900/70 px-1 py-0.5 text-[11px] text-amber-100">
