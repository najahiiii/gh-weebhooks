    ...
    return [
      {
        ...
        icon: Users,
        iconClass: "border-sky-500/40 bg-sky-500/10 text-sky-100",
        labelClass: "text-sky-200",
        cardGlow:
          "hover:border-sky-500/40 shadow-[0_20px_45px_-35px_rgba(56,189,248,0.75)]",
      },
      {
        label: "Bots",
        value: summary.bots,
        ...
        icon: Bot,
        iconClass: "border-emerald-500/40 bg-emerald-500/10 text-emerald-100",
        labelClass: "text-emerald-200",
        cardGlow:
          "hover:border-emerald-500/40 shadow-[0_20px_45px_-35px_rgba(16,185,129,0.75)]",
      },
      {
        label: "Destinations",
        ...
        icon: MapPin,
        iconClass: "border-amber-500/40 bg-amber-500/10 text-amber-100",
        labelClass: "text-amber-200",
        cardGlow:
          "hover:border-amber-500/40 shadow-[0_20px_45px_-35px_rgba(245,158,11,0.7)]",
      },
      {
        label: "Subscriptions",
        ...
        icon: GitBranch,
        iconClass: "border-violet-500/40 bg-violet-500/10 text-violet-100",
        labelClass: "text-violet-200",
        cardGlow:
          "hover:border-violet-500/40 shadow-[0_20px_45px_-35px_rgba(139,92,246,0.7)]",
      },
      {
        label: "Events logged",
        ...
        icon: Activity,
        iconClass: "border-pink-500/40 bg-pink-500/10 text-pink-100",
        labelClass: "text-pink-200",
        cardGlow:
          "hover:border-pink-500/40 shadow-[0_20px_45px_-35px_rgba(236,72,153,0.7)]",
      },
    ];
  }, [data]);
          ...
          <CardHeader className="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div className="space-y-4">
              <div className="flex flex-wrap items-center gap-2 text-xs">
                <Badge
                  variant="sky"
                  className="flex items-center gap-1 rounded-full border-sky-500/40 bg-sky-500/10 px-3 py-1 text-sky-100">
                  Insights
                </Badge>
              ...
              <CardDescription className="text-sm text-slate-300">
                A bird’s-eye view of users, bots, destinations, and the most
          ...
          {summaryTiles.map((tile) => {
            ...
            return (
              <Card
                key={tile.label}
                className={cn(
                  "relative overflow-hidden border border-slate-800/60 bg-slate-950/80 transition",
                  tile.cardGlow
                )}>
        ...
        <Card className="border-slate-800/60 bg-slate-950/75">
          <CardHeader className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <CardDescription>
                Masked Telegram IDs plus a quick tally of resources owned by
                each admin.
              </CardDescription>
            </div>
            <Badge
              variant="default"
              className="rounded-full border-slate-800/60 bg-slate-900/60 text-[11px] uppercase tracking-wide text-slate-300">
                    ...
                    <tr key={user.id} className="hover:bg-slate-900/60">
                      ...
                      <td className="px-4 py-3">
                        {user.isAdmin ? (
                          <Badge
                            variant="emerald"
                            className="rounded-full border-emerald-500/40 bg-emerald-500/10 text-[10px] uppercase tracking-wide">
                            Admin
                          </Badge>
                        ) : (
        ...
        <Card className="border-slate-800/60 bg-slate-950/75">
          <CardHeader className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <CardDescription>
                The most recent 50 subscriptions with their destinations.
              </CardDescription>
            </div>
            <Badge
              variant="default"
                  ...
                  <div
                    ...
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        <Badge
                          variant="default"
                          className="border-slate-700/60 bg-slate-900/70 text-[10px] uppercase tracking-wide">
                          {sub.events}
                        </Badge>
                      </div>
                    ...
                    <div className="mt-3 grid gap-2 text-xs text-slate-400 sm:grid-cols-2">
                      ...
                      <div className="flex flex-wrap items-center gap-1">
                        ...
                        <span className="text-slate-200">
                          {destinationHasTitle
                            ? sub.destinationTitle
                            : sub.destinationMasked}
                        </span>
                        {destinationHasTitle && (
                          <span className="text-slate-600">
                            ({sub.destinationMasked})
        ...
        <Card className="border-slate-800/60 bg-slate-950/75">
          <CardHeader className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <CardDescription>
                The latest 50 webhook deliveries with status and rich summaries.
              </CardDescription>
            </div>
            <Badge
              variant="default"
